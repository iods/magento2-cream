...
return [
    'modules' => [
        ...
        'Amazon_Payment' => 1,
        'Darkstar_Catalog' => 0,
        'Darkstar_OrderHistory' => 0,
        'Darkstar_OrderPrefix' => 0,
        'Darkstar_Payments' => 0,
        'Darkstar_Runner' => 0,
        'Darkstar_WelcomeDiscount' => 0,
        'Dotdigitalgroup_Email' => 1,
        'Dotdigitalgroup_Chat' => 1,
        'Dotdigitalgroup_Sms' => 1,
        'Iods_Core' => 0,
        'Iods_AcuityCatalog' => 0,
        'Iods_Config' => 0,
        'Iods_AcuityRx' => 0,
        'Iods_CoreUi' => 0,
        'Iods_Acuity' => 0,
        ...
        'Iods_Bunyan' => 0,
        'Iods_Catalog' => 0,
        'Iods_AcuityDeveloper' => 0,
        'Iods_Developer' => 0,
        'Iods_AcuityTheme' => 0,
        'Iods_AcuityWidgets' => 0,
        'Iods_Customer' => 0,
        'Iods_CustomerOffers' => 0,
        'Iods_Connect' => 0,
        'Iods_Flex' => 0,
        'Iods_Frostbite' => 0,
        'Iods_Lipstick' => 0,
